-- ============================================================
-- ScienceDirect 独立表的检索 RPC
-- ============================================================

create or replace function match_sciencedirect_papers_exact(
...
as $$
  ...
  from public.sciencedirect_papers p
...
create or replace function match_sciencedirect_papers_bm25(
  query_text text,
  match_count int,
  filter_published_start timestamptz default null,
  filter_published_end timestamptz default null
